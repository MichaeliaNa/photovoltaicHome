...
<form action="/admin/service/product/add" method="post" class="form form-horizontal" id="form-product-add">
  ...
  <div class="row cl">
    ...
    <div class="formControls col-8">
      ...
      <input type="file" name="file" id="input_id1" style="display: none;" onchange="return uploadImageToServer('input_id1','images', 'preview_id1', 'preview_src1');" />
      <input type="hidden" class="input-text" value="" id="preview_src1" name = "preview_src1">
      ...
      <input type="file" name="file" id="input_id2" style="display: none;" onchange="return uploadImageToServer('input_id2','images', 'preview_id2', 'preview_src2');" />
      <input type="hidden" class="input-text" value="" id="preview_src2" name = "preview_src2">
      ...
      <input type="file" name="file" id="input_id3" style="display: none;" onchange="return uploadImageToServer('input_id3','images', 'preview_id3', 'preview_sr3');" />
      <input type="hidden" class="input-text" value="" id="preview_src3" name = "preview_src3">
      ...
      <input type="file" name="file" id="input_id4" style="display: none;" onchange="return uploadImageToServer('input_id4','images', 'preview_id4', 'preview_src4');" />
      <input type="hidden" class="input-text" value="" id="preview_src4" name = "preview_src4">
      ...
      <input type="file" name="file" id="input_id5" style="display: none;" onchange="return uploadImageToServer('input_id5','images', 'preview_id5', 'preview_src5');" />
      <input type="hidden" class="input-text" value="" id="preview_src5" name = "preview_src5">
    </div>
  </div>
  <div class="row cl">
    ...
    callback:function(form){
      $('#form-product-add').ajaxSubmit({
          ...
          data: {
            ...
            preview_src: ($('#preview_id').attr('src')!='/admin/images/icon-add.png'?$('#preview_id').attr('src'):''),
            content: ue.getContent(),
            preview_src1: ($('#preview_id1').attr('src')!='/admin/images/icon-add.png'?$('#preview_id1').attr('src'):''),
            preview_src2: ($('#preview_id2').attr('src')!='/admin/images/icon-add.png'?$('#preview_id2').attr('src'):''),
            preview_src3: ($('#preview_id3').attr('src')!='/admin/images/icon-add.png'?$('#preview_id3').attr('src'):''),
            preview_src4: ($('#preview_id4').attr('src')!='/admin/images/icon-add.png'?$('#preview_id4').attr('src'):''),
            preview_src5: ($('#preview_id5').attr('src')!='/admin/images/icon-add.png'?$('#preview_id5').attr('src'):''),
            _token: "{{csrf_token()}}"
          },
