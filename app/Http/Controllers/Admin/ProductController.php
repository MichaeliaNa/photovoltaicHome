...
class ProductController extends Controller
{
  ...
  public function toProductAdd() {
    $categories = Category::whereNotNull('parent_id')->get();//二级类别的展示
  ...
  public function productAdd(Request $request)
  {
    ...
    $preview = $request->input('preview_src', '');
    $content = $request->input('content', '');

    $preview1 = $request->input('preview_src1', '');
    $preview2 = $request->input('preview_src2', '');
    $preview3 = $request->input('preview_src3', '');
    $preview4 = $request->input('preview_src4', '');
    $preview5 = $request->input('preview_src5', '');
